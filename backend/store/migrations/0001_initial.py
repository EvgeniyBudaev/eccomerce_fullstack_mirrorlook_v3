# Generated by Django 3.2.5 on 2021-08-13 05:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.CharField(blank=True, choices=[('Круглая', 'Круглая'), ('Овальная', 'Овальная'), ('Прямоугольная', 'Прямоугольная'), ('Фигурная', 'Фигурная')], max_length=64, null=True, verbose_name='Форма зеркала')),
