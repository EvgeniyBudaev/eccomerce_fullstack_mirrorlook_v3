  ...
  return (
    <Layout is404>
      <div className={styles.Error404}>
        <div className={styles.Link} onClick={handleRouteBack}>
              ...
              <div className={styles.RowBlock}>
                ...
                >
                  <g id="OBJECTS">
                    ...
                    <g ref={zeroRef} className={styles.Zero}>
                      <path
                        id="Vector_25"
